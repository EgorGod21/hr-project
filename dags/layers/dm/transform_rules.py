...
def generate_unique_full_names(
        count: int
) -> t.List[str]:
    """
    Функция генерации списка уникальных полных имен.
...
def etl_dar_employees(
    ...
    # Замена отсутствующих фамилий на сгенерированные значения
    for idx, full_name in zip(na_first, names_list):
        first_name, last_name = full_name.split()
        result_df.at[idx, 'Фамилия'] = last_name

    # Замена отсутствующих имен на сгенерированные значения
