-- Создание схемы "ods"
CREATE SCHEMA IF NOT EXISTS ods_ira;

--Создание таблицы "базы_данных" 
CREATE TABLE IF NOT EXISTS ods_ira.базы_данных (
...
CREATE TABLE IF NOT EXISTS ods_ira.базы_данных_и_уровень_знаний_сотру (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.инструменты (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.инструменты_и_уровень_знаний_сотр (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.образование_пользователей (
	"User ID" int4 NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.опыт_сотрудника_в_отраслях (
	"User ID" int4 NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.опыт_сотрудника_в_предметных_обла (
	"User ID" int4 NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.отрасли (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.платформы (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.платформы_и_уровень_знаний_сотруд (
	"User ID" int4 NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.предметная_область (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.резюмедар (
	"UserID" int4 NULL,
	"ResumeID" int4 NULL,
	"Активность" text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.сертификаты_пользователей (
	"User ID" int4 NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.сотрудники_дар (
	id int4 NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.среды_разработки (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.среды_разработки_и_уровень_знаний_ (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.технологии (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.технологии_и_уровень_знаний_сотру (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.типы_систем (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.типы_систем_и_уровень_знаний_сотру (
	название varchar(50) NULL,
	активность varchar(50) NULL,
	"Сорт." int4 NULL,
	"Дата изм." varchar(50) NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.уровень_образования (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.уровни_владения_ин (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.уровни_знаний (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.уровни_знаний_в_отрасли (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.уровни_знаний_в_предметной_област (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.фреймворки (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.фреймворки_и_уровень_знаний_сотру (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.языки (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.языки_пользователей (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.языки_программирования (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
...
CREATE TABLE IF NOT EXISTS ods_ira.языки_программирования_и_уровень (
	название text NULL,
	активность text NULL,
	"Сорт." int4 NULL,
	"Дата изм." text NULL,
