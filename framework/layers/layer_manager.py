...
class LayerManager:
    ...
    def etl_process_implementation(
        ...
        self.rules.target_engine = target_engine
        self.rules.source_engine = source_engine
        self.rules.target_schema = target_schema
        self.rules.source_schema = source_schema
